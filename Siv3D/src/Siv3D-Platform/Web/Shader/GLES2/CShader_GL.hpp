...
namespace s3d
{
	...
	public:
		...
		void setPSSamplerUniforms(PixelShaderID handleID);
		void setVSUniforms(VertexShaderID handleID, const void* uniformBuffer);
		void setPSUniforms(PixelShaderID handleID, const void* uniformBuffer);
	};
}
