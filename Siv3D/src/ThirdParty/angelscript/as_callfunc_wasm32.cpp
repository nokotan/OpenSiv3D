...
extern "C" int s3dCallIndirect(funcptr_t func, const asBYTE* sig, void* retPtr, void* argPtr);
extern "C" int s3dCallIndirectReturnInMemory(funcptr_t func, const asBYTE* sig, void* retPtr, void* argPtr);
